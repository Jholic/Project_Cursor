...
export function WeightChart() {
  ...
  if (data.length < 2) {
    return <div className="text-sm text-zinc-600 dark:text-zinc-400 text-center py-8">그래프를 보려면 최소 두 개의 기록이 필요합니다.</div>
  }
  ...
  return (
    <div className="w-full bg-white dark:bg-zinc-900 rounded border border-zinc-200 dark:border-zinc-800 p-4">
